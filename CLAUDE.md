...
### 自動コミット・プッシュのルール（AI向け・重要）

**Claude Code は、ある程度コード実装が進んだら、自動的にコミット・プッシュすること。**

#### いつコミット・プッシュすべきか

以下のタイミングで**自動的に**コミット・プッシュを行う：
...
- **コミット直後に自動的にプッシュする**
- ユーザーが明示的に「プッシュしないで」と指示した場合のみ、ローカルコミットに留める
