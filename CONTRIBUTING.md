...
voicekeyへの貢献に興味を持っていただき、ありがとうございます！
...
```bash
git clone https://github.com/YOUR_USERNAME/voicekey.git
cd voicekey
```
...
voicekeyは **Semantic Versioning (vX.Y.Z)** を採用しています。
...
- **バグ報告**: [GitHub Issues](https://github.com/Tomato-1101/voicekey/issues) で報告
- **機能リクエスト**: Issue で提案
...
**ありがとうございます！あなたの貢献がvoicekeyをより良いものにします。**
